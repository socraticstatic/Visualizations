...
/**
 * ECharts CDN script tag for the standalone report. Version-pinned with
 * Subresource Integrity: a floating `echarts@5` tag would let a compromised
 * CDN (or a silently re-published dist file) run arbitrary script in the
 * exported report. sha384 computed from
 * https://cdn.jsdelivr.net/npm/echarts@5.6.0/dist/echarts.min.js.
 */
const ECHARTS_CDN_SCRIPT =
