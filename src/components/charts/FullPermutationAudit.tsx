 ...
 */
export interface FullPermutationAuditProps {
  hasManualOverrides: boolean;
}

export function FullPermutationAudit({ hasManualOverrides }: FullPermutationAuditProps) {
      ...
      <div className="flex flex-wrap items-center gap-2 px-3 py-2 text-xs">
        ...
        >
          ...
          {running ? (
            ...
            <span>
              {totalChecked} (theme × kind × N) permutation
              {totalChecked === 1 ? "" : "s"} ·{" "}
              {anyFailures ? (
